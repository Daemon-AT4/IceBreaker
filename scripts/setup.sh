...
if [[ "$SETUP_FAILED" -eq 0 ]]; then
  ...
  echo ""
  echo -e "  ${YELLOW}╔══════════════════════════════════════════════════════════╗${NC}"
  echo -e "  ${YELLOW}║  ${BOLD}IMPORTANT: Change the username to match yours!${NC}         ${YELLOW}║${NC}"
  echo -e "  ${YELLOW}╠══════════════════════════════════════════════════════════╣${NC}"
  echo -e "  ${YELLOW}║${NC}                                                          ${YELLOW}║${NC}"
  echo -e "  ${YELLOW}║${NC}  The default username is ${BOLD}archangel${NC}. Change it to the     ${YELLOW}║${NC}"
  echo -e "  ${YELLOW}║${NC}  username you chose when installing NixOS.                ${YELLOW}║${NC}"
  echo -e "  ${YELLOW}║${NC}                                                          ${YELLOW}║${NC}"
  echo -e "  ${YELLOW}║${NC}  Replace ${BOLD}archangel${NC} with your username in these files:    ${YELLOW}║${NC}"
  echo -e "  ${YELLOW}║${NC}    ${DIM}modules/system/base.nix${NC}         ${DIM}(users.users.*)${NC}       ${YELLOW}║${NC}"
  echo -e "  ${YELLOW}║${NC}    ${DIM}modules/system/nix-helpers.nix${NC}  ${DIM}(trusted-users)${NC}       ${YELLOW}║${NC}"
  echo -e "  ${YELLOW}║${NC}    ${DIM}home/default.nix${NC}               ${DIM}(username + homeDir)${NC}  ${YELLOW}║${NC}"
  echo -e "  ${YELLOW}║${NC}    ${DIM}flake.nix${NC}                      ${DIM}(users.*)${NC}             ${YELLOW}║${NC}"
  echo -e "  ${YELLOW}║${NC}                                                          ${YELLOW}║${NC}"
  echo -e "  ${YELLOW}║${NC}  Then rebuild: ${BOLD}sudo nixos-rebuild switch --flake .${NC}       ${YELLOW}║${NC}"
  echo -e "  ${YELLOW}╚══════════════════════════════════════════════════════════╝${NC}"
  echo ""
  echo -e "  ${YELLOW}╔══════════════════════════════════════════════════════════╗${NC}"
  echo -e "  ${YELLOW}║  ${BOLD}VMware guest support is enabled by default.${NC}            ${YELLOW}║${NC}"
  echo -e "  ${YELLOW}╠══════════════════════════════════════════════════════════╣${NC}"
  echo -e "  ${YELLOW}║${NC}                                                          ${YELLOW}║${NC}"
  echo -e "  ${YELLOW}║${NC}  If you're using a different hypervisor, edit             ${YELLOW}║${NC}"
  echo -e "  ${YELLOW}║${NC}  ${BOLD}modules/system/base.nix${NC} and set:                        ${YELLOW}║${NC}"
  echo -e "  ${YELLOW}║${NC}    ${DIM}virtualisation.vmware.guest.enable = false;${NC}            ${YELLOW}║${NC}"
  echo -e "  ${YELLOW}║${NC}  Then enable the correct one (QEMU/KVM or VirtualBox).   ${YELLOW}║${NC}"
  echo -e "  ${YELLOW}║${NC}  See the comments in that file.                          ${YELLOW}║${NC}"
  echo -e "  ${YELLOW}╚══════════════════════════════════════════════════════════╝${NC}"
  echo ""
  echo "  Next steps:"
  echo ""
  echo -e "  ${GREEN}1.${NC} Change ${BOLD}archangel${NC} to your username in the files above"
  echo -e "  ${GREEN}2.${NC} Rebuild: ${BOLD}sudo nixos-rebuild switch --flake ~/IceBreaker${NC}"
  echo -e "  ${GREEN}3.${NC} ${BOLD}Reboot${NC} the system"
